...
function advancedExponent(b, n) {
  ...
  if (n % 2 === 0) {
    ...
    let oddHalfPower = advancedExponent(b, (n - 1) / 2);
    return b * oddHalfPower ** 2
  }
}

console.log(advancedExponent(2, 0), 1); // 1
console.log(advancedExponent(2, 1), 2); // 2
console.log(advancedExponent(2, 2), 3); // 4
console.log(advancedExponent(2, 3), 4); // 8
console.log(advancedExponent(2, 4), 5); // 16
console.log(advancedExponent(2, 5), 6); // 32
console.log(advancedExponent(2, 6), 7); // 64
console.log(advancedExponent(2, 7), 8); // 128
console.log(advancedExponent(2, 8), 9); // 256
console.log(advancedExponent(2, 9), 10); // 512
console.log(advancedExponent(2, 10), 11); // 1024
console.log(advancedExponent(2, 11), 12); // 2048
console.log(advancedExponent(2, 12), 13); // 4096
